        ...
        <view class="banner-content">
          ...
          <view class="banner-info">
            ...
            <text class="banner-desc"
              >{{ allComponents.length }} 个组件 · 统一风格 · 开箱即用</text
            >
          </view>
        </view>
      </view>
...
<script setup lang="ts">
  ...
  const allComponents = ref([
    ...
    },
    {
      ...
      category: 'layout',
      icon: 'backtop',
      gradient: 'linear-gradient(135deg, #4ecdc4, #2bcbba)',
    ...
    },
    {
      ...
      category: 'layout',
      icon: 'dashboard',
      gradient: 'linear-gradient(135deg, #45b7d1, #4834d4)',
    ...
    },
    {
      ...
      category: 'layout',
      icon: 'menu-fold',
      gradient: 'linear-gradient(135deg, #96ceb4, #88d8b0)',
    ...
    },
    {
      ...
      category: 'display',
      icon: 'bianjiliebiao',
      gradient: 'linear-gradient(135deg, #dfe6e9, #636e72)',
