    ...
    <view class="demo-page">
      ...
      <view class="demo-section">
        ...
        <view class="demo-card">
          ...
          <view class="code-block mt-3">
            &lt;C_Modal v-model:visible="show" title="确认操作"
            content="确定要删除吗？" @confirm="onConfirm" /&gt;
          </view>
        </view>
      </view>
      ...
      <view class="demo-section">
        ...
        <view class="demo-card">
          ...
          <view class="code-block mt-3">
            &lt;C_Modal title="用户协议"&gt; &lt;view&gt;自定义内容&lt;/view&gt;
            &lt;/C_Modal&gt;
          </view>
        </view>
      </view>
