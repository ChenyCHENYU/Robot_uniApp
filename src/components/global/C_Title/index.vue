<template>
  <view
    ...
    :class="[
      ...
      {
        'cursor-pointer transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0':
          clickable,
      },
    ]"
    :style="wrapperStyle"
  ...
  >
    ...
    >
      ...
      <!-- 边框光效 -->
      <view
        class="absolute inset-0 rounded-2xl border border-white/30 pointer-events-none"
      ></view>
    </view>
  </view>
</template>
