<template>
  ...
  >
    ...
    <!-- 空状态 -->
    <C_Empty v-if="showEmpty" :type="emptyType" :text="emptyText" />

    <!-- 加载中 -->
    <view v-if="loading && !showEmpty" class="c-list__status">
      <wd-loading class="c-list__loading-icon" :size="16" />
    ...
    <!-- 全部加载完毕 -->
    <view v-if="finished && !showEmpty && !error" class="c-list__finished">
      {{ finishedText }}
    </view>
  </scroll-view>
</template>
